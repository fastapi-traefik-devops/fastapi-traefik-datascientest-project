...
├── kustomization.yaml
├── sealed-secret-backend.yaml.example    # shape of the generated file (template, not applied)
├── sealed-secret-db.yaml.example         # shape of the generated file (template, not applied)
├── sealed-secret-frontend.yaml.example   # shape of the generated file (template, not applied)
├── sealed-secret-backend.yaml    # generated by scripts/seal-secrets.sh — see Secrets below
├── sealed-secret-db.yaml         # generated by scripts/seal-secrets.sh — see Secrets below
└── sealed-secret-frontend.yaml   # generated by scripts/seal-secrets.sh — see Secrets below
```
